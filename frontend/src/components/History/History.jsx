...
export default function History({ onLoad }) {
    ...
    <div style={{ padding: '20px' }}>
      {[1, 2, 3].map(i => (
        <div key={i} style={{
          ...
          background: 'linear-gradient(90deg, #f8fafc 25%, #e2e6ec 50%, #f8fafc 75%)',
  ...
  if (sessions.length === 0) return (
    <div style={{ textAlign: 'center', padding: '60px 20px' }}>
      ...
      <p style={{ color: '#94a3b8', fontSize: '13px' }}>Complete your first interview practice to see it here</p>
    </div>
  );
      ...
      {sessions.map(session => {
        ...
        return (
          <div
            ...
            onMouseOut={e => { e.currentTarget.style.borderColor = '#e2e6ec'; e.currentTarget.style.background = '#ffffff'; }}
          >
            {/* Category icon */}
            <div style={{
            ...
            <div style={{ flex: 1, overflow: 'hidden' }}>
              <p style={{ color: '#0f172a', fontWeight: '700', fontSize: '15px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', marginBottom: '4px' }}>
                {session.role}
              </p>
              <p style={{ color: '#64748b', fontSize: '12px', display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
            ...
            <div style={{ textAlign: 'center', flexShrink: 0 }}>
              ...
              <p style={{ color: '#64748b', fontSize: '11px', fontWeight: '600' }}>/10</p>
            </div>
